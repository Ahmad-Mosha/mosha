    ...
    <header className="sticky top-0 z-40 h-13 bg-[#FDFDFD]/90 backdrop-blur-md border-b border-[#E2E8F0] px-6 flex items-center justify-between transition-all">
      ...
      <div className="flex items-center space-x-6">
        ...
        <button
          ...
          className="hidden sm:flex items-center space-x-2.5 px-3 py-1.5 rounded-lg bg-[#F8F9FA] hover:bg-[#F1F3F5] border border-[#E2E8F0] text-xs text-[#718096] transition-colors shadow-2xs group"
        >
          <Search className="w-3.5 h-3.5 text-[#A0AEC0] group-hover:text-[#4A5568]" />
          <span className="text-xs">Search everything in Mosha...</span>
      ...
      <div className="flex items-center space-x-3">
        ...
        <div className="flex items-center space-x-2 px-2.5 py-1 rounded-lg bg-[#F8F9FA] border border-[#E2E8F0] text-xs font-mono">
          ...
          <button
            ...
            className="p-1 text-[#4A5568] hover:text-[#1A202C] transition-colors"
          ...
          <button
            onClick={resetFocus}
            className="p-1 text-[#A0AEC0] hover:text-[#4A5568] transition-colors"
            title="Reset timer"
          >
        ...
        <button
          onClick={() => setCommandMenuOpen(true)}
          className="p-2 rounded-lg text-[#718096] hover:text-[#1A202C] hover:bg-[#F3F4F6] transition-colors"
