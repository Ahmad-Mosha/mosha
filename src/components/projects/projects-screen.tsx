        ...
        <div className="flex items-center gap-2.5 text-xs">
          ...
          <div className="relative w-48 sm:w-60">
            ...
            <input
              ...
              className="w-full bg-subtle border border-line rounded-xl pl-8 pr-3 py-1.5 text-xs text-ink focus:outline-none focus:border-accent"
            />
          </div>
          ...
          <button
            ...
            className="px-4 py-2 bg-accent hover:bg-accent-hover text-accent-fg rounded-xl text-xs font-semibold shadow-xs transition-colors flex items-center gap-1.5 cursor-pointer"
          >
        ...
        <div className="max-w-7xl mx-auto space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
              ...
              >
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between items-start gap-2">
                    <h3 className="font-serif text-base font-bold text-ink group-hover:text-accent transition-colors line-clamp-1">
                      {project.name}
                    </h3>
                  ...
                  {/* Description */}
                  <p className="text-xs text-muted line-clamp-2 leading-relaxed h-9">
                ...
                <div className="mt-4 pt-3 border-t border-line flex justify-between items-center text-xs">
                  <div className="flex gap-1 flex-wrap items-center max-w-[70%] overflow-hidden">
                    {(project.techStack || []).slice(0, 3).map((tech: string) => (
                      <span
                        key={tech}
                        className="px-2 py-0.5 bg-subtle border border-line rounded font-mono text-[10px] text-muted font-medium"
                      >
                        {tech}
                      </span>
                    ))}
            ...
            >
              ...
              <span className="font-semibold text-xs text-faint group-hover:text-accent transition-colors">
